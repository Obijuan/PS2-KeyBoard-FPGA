{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "82a07f16-a0bf-4217-bfa0-f86dfc17a088",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "e849b37f-e57e-4cd7-b655-6d97ae6037f8",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "26a511ff-20e5-436f-adfc-861cfd121aba",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "147d6602-ff87-4a5a-95e2-b73c941eb665",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "24aba354-3844-49c7-b3bd-4ab9be89968b",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "fc04e3d0-a697-464f-9f2b-803097e19617",
        ...
        {
          "id": "70a546cc-19cd-40bb-a7e8-b8a4839de993",
          "type": "e9949a5c4ba7e099b3dcfa361362ac25be2ad6cb",
          "position": {
            "x": 1216,
            "y": -104
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "fc04e3d0-a697-464f-9f2b-803097e19617",
        ...
        },
        {
          ...
          "target": {
            "block": "e849b37f-e57e-4cd7-b655-6d97ae6037f8",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "70a546cc-19cd-40bb-a7e8-b8a4839de993",
            "port": "d8b85f67-c352-499e-b923-dd128d980efa"
          },
          "target": {
            "block": "26a511ff-20e5-436f-adfc-861cfd121aba",
            "port": "in"
          },
          "vertices": []
        },
        ...
        },
        {
          ...
          "target": {
            "block": "82a07f16-a0bf-4217-bfa0-f86dfc17a088",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "24aba354-3844-49c7-b3bd-4ab9be89968b",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "147d6602-ff87-4a5a-95e2-b73c941eb665",
            "port": "in"
          }
        }
      ]
